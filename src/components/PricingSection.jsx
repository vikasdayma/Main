...
const PricingCard = ({ plan }) => (
  <div className="group relative w-80 mt-6 z-10 ">
    <div className="relative overflow-hidden rounded-2xl bg-[#11161D] p-[1px] shadow-2xl transition-all duration-300 hover:-translate-y-2 hover:shadow-[#00C9A7]/40">
      <div className="absolute inset-0 bg-gradient-to-b from-[#00C9A7] to-transparent opacity-20"></div>
      <div className="relative rounded-2xl bg-[#0F0F0F] p-6 text-white">
...
export default function PricingSection() {
  return (
    <> 
      <h2 className="text-3xl mt-10  md:text-5xl text-center font-bold  text-white">Pricing Section</h2>
    <div className="relative min-h-screen mt-6 bg-[#0B0B0F] text-white overflow-hidden py-10  flex flex-col md:flex-row justify-between px-17 items-start  gap-10">
